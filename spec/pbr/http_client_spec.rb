...
describe ProductBoard::HttpClient do
  let(:basic_client) do
    options = ProductBoard::Client::DEFAULT_OPTIONS
                .merge(ProductBoard::HttpClient::DEFAULT_OPTIONS)
                .merge(basic_auth_credentials)
    ProductBoard::HttpClient.new(options)
  end
