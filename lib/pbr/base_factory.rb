module ProductBoard
  ...
  class BaseFactory
    ...
    # ProductBoard::Resource::FooFactory creates ProductBoard::Resource::Foo instances.
    def target_class
      # Need to do a little bit of work here as Module.const_get doesn't work
      # with nested class names, i.e. ProductBoard::Resource::Foo.
      #
      # So create a method chain from the class components.  This code will
      # unroll to:
      #   Module.const_get('ProductBoard').const_get('Resource').const_get('Foo')
      #
    ...
    # list.
    delegate_to_target_class :all, :find, :collection_path, :singular_path, :jql, :get_features, :get_board_issues, :get_sprints, :get_sprint_issues, :get_projects, :get_projects_full
